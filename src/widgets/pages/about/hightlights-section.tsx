  ...
  return (
    <section>
      <div className="content-container py-16 md:py-32">
        <h3 className="text-3xl lg:text-4xl xl:text-5xl font-bold leading-[140%] xl:leading-[67.2px] uppercase">
          THE DIFFERENCE IS CLEAR
        </h3>
        <div className="max-w-[640px] font-medium mt-8">
          <div className="text-[#4B4B4B]">
            <div className="space-y-8 text-sm lg:text-2xl ">
              <p className="max-w-[31.875rem]">
                We provide a wide range of payment solutions to individuals and
                businesses worldwide. Our services include:
              </p>
              ...
              <div>
                <Paragraph size="small">
                  ...
                  payment solutions to individuals and businesses worldwide, and
                  we are proud to serve customers in multiple countries and
                  regions.
                </Paragraph>
              </div>
            </div>
