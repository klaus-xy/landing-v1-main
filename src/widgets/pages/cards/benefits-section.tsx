...
const benefits = [
  {
    ...
    body: "Customize your cards how you want  to suit your taste and needs.",
  },
  {
    title: "LOW FEES",
    body: "Get a card for as low as 5 dollars. No hidden fees or maintenance charges.",
  },
  {
    title: "BROAD ACCEPTANCE",
    body: "Spend without restrictions. Make payments online anywhere in the world.",
  },
];

const CardsBenefitsSection = () => {
  return (
    <section className="bg-[#E9E9E9]/30 py-10 md:py-24">
      <div className="content-container">
        <AppTextBody
          ...
          title={<>GLOBAL TRANSACTIONS WITH EASE</>}
          description="Spend without borders. Shop anywhere, anytime with your Platnova virtual card and physical card."
        />

        <div className="grid md:grid-cols-3 gap-5 lg:gap-8 mt-10 md:mt-20">
          {benefits.map(({ title, body }, index) => (
            <div
              data-scroll
              data-scroll-speed={index}
              key={`benefits-${index}`}
              className="bg-white rounded-3xl p-7 lg:p-10 gap-7 flex flex-col justify-between"
            >
              <div className="space-y-2">
                ...
                >
                  <rect
                    width="24"
                    height="24"
                    fill="url(#pattern0_3327_4172)"
                  />
                  <defs>
                    <pattern
                      id="pattern0_3327_4172"
                      patternContentUnits="objectBoundingBox"
                      width="1"
                      height="1"
                    >
                      <use
                        xlinkHref="#image0_3327_4172"
              ...
              <div className="text-right lg:w-10/12 ml-auto">
                <p className="text-[#4B4B4B] text-sm">{body}</p>
              </div>
            </div>
          ))}
        </div>
...
export default CardsBenefitsSection;
